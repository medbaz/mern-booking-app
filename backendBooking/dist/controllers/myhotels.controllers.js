...
exports.deletHotel = exports.editHotelById = exports.getHotelById = exports.getHotels = exports.deletAll = exports.postHotels = void 0;
...
const deletHotel = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const hotelId = req.params.id.toString();
        console.log(hotelId);
        const hotel = yield user_model_1.Hotel.findOneAndDelete({
            _id: hotelId,
            userId: req.userId,
        });
